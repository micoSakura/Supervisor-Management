                ...
                <li class="layui-nav-item layuimini-setting">
                    <a href="javascript:;">
                        <c:choose>
                            ...
                            <c:when test="${sessionScope.type.equals('supervisor')}">
                                ${sessionScope.supervisor.loginName}
                            </c:when>
                        </c:choose>
                    </a>
                    <dl class="layui-nav-child">
                        <dd>
                            <c:choose>
                                <c:when test="${sessionScope.type.equals('admin')}">
                                    <a href="javascript:;" layuimini-content-href="adminInfo"
                                       data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                                </c:when>
                                <c:when test="${sessionScope.type.equals('supervisor')}">
                                    <a href="javascript:;" layuimini-content-href="supervisorInfo"
                                       data-title="基本资料" data-icon="fa fa-gears">基本资料</a>
                                </c:when>
                            </c:choose>
                        </dd>
...
<script>
    layui.use(['jquery', 'layer', 'miniAdmin'], function () {
        ...
        let options = {
            <c:choose>
            <c:when test="${sessionScope.type.equals('admin')}">
            iniUrl: "${pageContext.request.contextPath}/api/admin.json",
            </c:when>
            <c:when test="${sessionScope.type.equals('supervisor')}">
            iniUrl: "${pageContext.request.contextPath}/api/supervisor.json",
            </c:when>
            </c:choose>
