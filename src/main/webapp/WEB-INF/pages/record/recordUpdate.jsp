...
<div class="layui-form layuimini-form">
    <input type="hidden" name="recordNum" value="${infoRecord.recordNum}">
    <input type="hidden" name="listenNum" value="${infoListen.listenNum}">
    <div class="layui-form-item">
        <label class="layui-form-label required">课程名称</label>
        <div class="layui-input-block">
            <input type="text" name="courseName" placeholder="请输入课程名称"
                   value="${infoListen.courseList[0].courseName}" class="layui-input" disabled>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="teacherName" placeholder="请输入教师姓名"
                   value="${infoListen.courseList[0].teacherName}" class="layui-input" disabled>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="courseTime" id="courseTime" placeholder="请选择时间" class="layui-input" disabled
                   value="<fmt:formatDate value='${infoListen.courseList[0].courseTime}' pattern='HH:mm:ss'/>">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="text" name="courseAddress" placeholder="请输入上课地点"
                   value="${infoListen.courseList[0].courseAddress}" class="layui-input" disabled>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="selection" lay-verify="required" lay-reqtext="选课人数不能为空"
                   placeholder="选课人数" class="layui-input" value="${infoRecord.selection}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="attendance" lay-verify="required" lay-reqtext="出勤人数不能为空"
                   placeholder="出勤人数" class="layui-input" value="${infoRecord.attendance}">
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="evaluation" lay-verify="required" lay-reqtext="课堂评分不能为空"
                   placeholder="课堂评分" class="layui-input" value="${infoRecord.evaluation}">
        </div>
    </div>
        ...
        <div class="layui-input-block">
            <label>
                <textarea placeholder="请输入内容" lay-verify="required" class="layui-textarea"
                          name="courseContent">${infoRecord.courseContent}</textarea>
            </label>
        </div>
    </div>
    <div class="layui-form-item layui-form-text">
        ...
        <div class="layui-input-block">
            <label>
                <textarea placeholder="请输入意见" lay-verify="required" class="layui-textarea"
                          name="suggestion">${infoRecord.suggestion}</textarea>
            </label>
        </div>
    </div>
