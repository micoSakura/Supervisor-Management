...
<div class="layui-form layuimini-form">
    <input type="hidden" name="supNum" value="${info.id}">
    <div class="layui-form-item">
        <label class="layui-form-label required">督导秘书姓名</label>
        <div class="layui-input-block">
            <input type="text" name="realName" lay-verify="required" lay-reqtext="督导秘书姓名不能为空"
                   placeholder="请输入督导秘书姓名" value="${info.realName}" class="layui-input">
        </div>
    </div>
    <div class="layui-form-item">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-block">
            <input type="number" name="phone" lay-verify="required" lay-reqtext="手机不能为空"
                   placeholder="请输入电话" value="${info.phone}" class="layui-input">
        </div>
    </div>
